...
const KNOWN_DEPTS = [
  ...
  { code: 'ECE', name: 'Electronics & Communication', icon: 'hardware-chip-outline', color: '#EC4899' },
  { code: 'CCE', name: 'Computer & Communication', icon: 'git-network-outline', color: '#F43F5E' },
  { code: 'EEE', name: 'Electrical & Electronics', icon: 'flash-outline', color: '#F59E0B' },
  { code: 'AIML', name: 'Artificial Intelligence & ML', icon: 'eye-outline', color: '#8B5CF6' },
  { code: 'AIDS', name: 'Artificial Intelligence & Data Science', icon: 'bar-chart-outline', color: '#06B6D4' },
  { code: 'CSBS', name: 'Computer Science & Business Systems', icon: 'briefcase-outline', color: '#6366F1' },
  { code: 'Mechanical', name: 'Mechanical Engineering', icon: 'settings-outline', color: '#4B5563' },
  { code: 'Civil', name: 'Civil Engineering', icon: 'business-outline', color: '#14B8A6' },
  { code: 'Chemical', name: 'Chemical Engineering', icon: 'flask-outline', color: '#EF4444' },
  { code: 'IOT', name: 'Internet of things', icon: 'pulse-outline', color: '#D946EF' },
];
